        ...
        <ScrollReveal delay={150}>
          <div className={styles.projectsGrid}>
            ...
            <div className={styles.projectCard}>
              ...
              <p className={styles.projectDesc}>Personal portfolio site built with Next.js, showcasing experience, skills, and projects with a clean, Apple-inspired design system.</p>
